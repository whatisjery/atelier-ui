...
<InstallGuide name="sphere-gallery" />
...
The gallery renders through a [WebGL Scene](/docs/foundation/primitive/webgl-scene) layered above other content. Set `mode="texture"` to render it into post-processing instead, so effects like `FluidDistortion` apply to the sphere:
