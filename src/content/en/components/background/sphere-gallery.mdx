...
The gallery renders through a [WebGL Scene](/docs/components/primitive/webgl-scene) layered above other content. Set `mode="texture"` to render it into post-processing instead, so effects like `FluidDistortion` apply to the sphere:
