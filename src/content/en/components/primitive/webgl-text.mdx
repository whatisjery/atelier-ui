---
title: "WebGL Text"
description: "A primitive that mirrors a text element onto a DOM-aligned WebGL plane so you can apply custom shaders without losing SEO or accessibility."
...
<InstalGuideCLI name="webgl-text" />

---

## Manual Install

<InstalGuideManual name="webgl-text" />
