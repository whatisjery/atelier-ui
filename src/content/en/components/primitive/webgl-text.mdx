---
title: "WebGL Text"
description: "A primitive that mirrors an text element onto a WebGL plane while preserving accessibility."
...
WebGL Text must be rendered inside a `WebglProvider`. Follow the [installation guide](/docs/getting-started/installation) to add it to your app root.
