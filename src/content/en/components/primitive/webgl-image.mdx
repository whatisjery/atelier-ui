---
title: "WebGL Image"
description: "A primitive that mirrors an image onto a DOM-aligned WebGL plane so you can apply custom shaders without losing SEO or accessibility."
tags: ["Primitive", "React Three Fiber"]
---

A structural building block for composing your own WebGL image effects, like [Curve Image](/docs/components/scroll/curve-image).
...
<InstalGuideCLI name="webgl-image" />

---

## Manual Install

<InstalGuideManual name="webgl-image" />
