...
- **SEO friendly**: compatible with search engines and screen readers.
- **Responsive**: ResizeObserver remeasures on container resize.
- **DPR-aware**: sharp rendering.
- **Alignment**: baseline aligned with the other text elements.
