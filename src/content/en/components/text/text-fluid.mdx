...
Text Fluid must be rendered inside a `WebglProvider`. Follow the [installation guide](/docs/getting-started/installation) to add it to your app root.
...
```tsx
<TextFluid>Liquid type</TextFluid>
```
