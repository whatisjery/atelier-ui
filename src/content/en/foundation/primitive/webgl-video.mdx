...
A structural building block for composing your own WebGL video effects. It is the video counterpart of [WebGL Image](/docs/foundation/primitive/webgl-image), so any `material` you write for one works on the other.
