...
This project uses [motion.dev](https://motion.dev/) for DOM-based animations, [React Three Fiber](https://r3f.docs.pmnd.rs/) for WebG effects, and [Tailwind CSS](https://tailwindcss.com/) for styling.
