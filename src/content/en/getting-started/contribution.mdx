...
Add the installation guide by using the `<InstallGuide />` component with **the same exact name** of the base component.
...
You can add interactive controls to the preview so users can tweak component props live.
