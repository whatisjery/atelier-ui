...
This project uses [motion.dev](https://motion.dev/) for DOM-based animations and [React Three Fiber](https://react-three-fiber.com/) for WebGL/shader effects. Choose the library that best fits the effect you are implementing.
