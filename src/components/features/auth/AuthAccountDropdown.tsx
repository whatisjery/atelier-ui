...
import { ArrowRight, Check, Copy, LoaderIcon, LogOut } from "lucide-react"
...
export default function AuthAccountDropdown({ customer, isLoadingCustomer, onSignOut }: Props) {
                ...
                >
                    {isLoadingCustomer && (
                        <div className="flex items-center justify-center py-4">
                            <LoaderIcon className="size-4 animate-spin text-mat-3" />
                        </div>
                    )}
